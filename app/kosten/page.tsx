          ...
          <aside className="col-span-12 lg:col-span-4">
            <div className="rounded-4xl border border-ink/10 bg-white p-7">
              ...
              <a
                ...
                className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-full bg-laub-500 px-6 py-3.5 text-[13px] font-medium text-bone transition-colors hover:bg-laub-600"
              >
                Projekt anfragen
                <span>&rarr;</span>
              </a>
            ...
            <table className="w-full min-w-[720px] border-collapse text-left">
              <thead>
                <tr className="border-b border-ink/15">
                  <th className="pb-3 pr-4 font-mono text-[10px] uppercase tracking-[0.18em] text-ink/50">Leistung</th>
                ...
                {tabelle.map((zeile) => (
                  <tr key={zeile.key} className="border-b border-ink/10">
                    <td className="py-4 pr-4">
                      <a href={`/leistungen/${zeile.slug}`} className="font-display text-[18px] tracking-tight text-ink hover:text-laub-600">
                        {zeile.label}
                      </a>
                    </td>
